		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav">
					<li><a href="welcome"><i class="fa fa-home"></i>
							Dashboard</a></li>
					<li class="actifxve"><a href="course"><i
									...
									<div class="col-sm-12">
										<ul class="list-group">
											<s:iterator value="list" var="i">
												<li class="list-group-item"><a href="#"><s:property
															value="course_Name" /></a></li>
											</s:iterator>
