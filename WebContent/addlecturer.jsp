				...
				<ul class="nav navbar-nav side-nav">
					...
					<li class="active"><a href="javascript:;"
						...
						data-toggle="collapse" data-target="#demo2"><i
							class="fa fa-graduation-cap"></i> Lecturers <i
							class="fa fa-fw fa-caret-down"></i></a>
						<ul id="demo2" class="collapse">
							<li><a href="addLecturer">Add New Lecturer</a></li>
							<li><a href="student">Manage Lecturers</a></li>
						</ul></li>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li class="active"><i class="fa fa-file"></i> Lecturer
								Details Page</li>
						</ol>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<!-- <div class="row"> -->
							...
							<form role="form" action="createLecture" >
								<div class="row">
									<div class="col-lg-2">								
								...
								<div class="row">
									...
									<div class="col-lg-3">
										<div class="form-group">
											<button type="submit" class="btn btn-primary" style="width: 100%;">Create New Lecturer</button>
										</div>
